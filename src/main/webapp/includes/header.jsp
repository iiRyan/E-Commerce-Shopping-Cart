   ...
   <div id="header">
    ...
    <header class="bg-gray-900">
        <div class="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
          <a class="block text-white  :text-teal-300" href="/">
          ...
          <div class="flex flex-1 items-center justify-end md:justify-between">
            <nav aria-label="Global" class="hidden md:block">
              <ul class="flex items-center text-indigo-600 gap-6 text-sm">
                <li>
                  <a
                    class="text-gray-500 transition  :text-white :hover:text-white/75"
                ...
                <li>
                  <a
                    class="text-gray-500 transition hover:text-gray-500/75 :text-white :hover:text-white/75"
           ...
           <span class="center relative inline-block select-none whitespace-nowrap rounded-lg bg-red-500 py-2 px-3.5 align-baseline font-sans text-xs
            ...
            <div class="flex items-center gap-4">
              <div class="sm:flex sm:gap-4">
                ...
                <a
                  class="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-indigo-600 transition hover:text-bg-indigo-700 bg-gray-800 :text-white :hover:text-indigo-600 sm:block"
                  href="/"
                >
                  Register
                </a>
              ...
              <button
                class="block rounded bg-gray-100 p-2.5 text-gray-600 transition hover:text-gray-600/75 :bg-gray-800 :text-white :hover:text-white/75 md:hidden"
              >
